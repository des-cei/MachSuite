...
void run_benchmark( void *vargs ) {
  ...
  artico3_kernel_create("sort", 32768, 4, 0);
  ...
  a3data_t *b = artico3_alloc(ITERATIONS * SIZE * sizeof *b, "sort", "b", A3_P_I);
  a3data_t *bucket = artico3_alloc(ITERATIONS * BUCKETSIZE * sizeof *bucket, "sort", "bucket", A3_P_I);
  a3data_t *sum = artico3_alloc(ITERATIONS * SCAN_RADIX * sizeof *sum, "sort", "sum", A3_P_I);
  ...
  artico3_free("sort", "a");
  artico3_free("sort", "b");
  artico3_free("sort", "bucket");
  artico3_free("sort", "sum");
