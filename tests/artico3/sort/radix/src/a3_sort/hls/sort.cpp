...
void local_scan(a3data_t bucket[BUCKETSIZE])
{
    a3data_t radixID, i, bucket_indx;
...
void sum_scan(a3data_t sum[SCAN_RADIX], a3data_t bucket[BUCKETSIZE])
{
    a3data_t radixID, bucket_indx;
    sum[0] = 0;
...
void last_step_scan(a3data_t bucket[BUCKETSIZE], a3data_t sum[SCAN_RADIX])
{
    a3data_t radixID, i, bucket_indx;
...
void init(a3data_t bucket[BUCKETSIZE])
{
    a3data_t i;
...
void hist(a3data_t bucket[BUCKETSIZE], a3data_t a[SIZE], a3data_t exp)
{
    a3data_t blockID, i, bucket_indx, a_indx;
    blockID = 0;
...
void update(a3data_t b[SIZE], a3data_t bucket[BUCKETSIZE], a3data_t a[SIZE], a3data_t exp)
{
    a3data_t i, blockID, bucket_indx, a_indx;
    blockID = 0;
...
A3_KERNEL(a3inout_t a, a3in_t b, a3in_t bucket, a3in_t sum) {
    a3data_t exp=0;
    a3data_t valid_buffer=0;
    #define BUFFER_A 0
    #define BUFFER_B 1
