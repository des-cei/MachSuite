...
char *readfile(FIL fd); // char *readfile(int fd);
...
int write_string(FIL fd, char *arr, int n); // int write_string(int fd, char *arr, int n);
int write_uint8_t_array(FIL fd, uint8_t *arr, int n); // int write_uint8_t_array(int fd, uint8_t *arr, int n);
int write_uint16_t_array(FIL fd, uint16_t *arr, int n); // int write_uint16_t_array(int fd, uint16_t *arr, int n);
int write_uint32_t_array(FIL fd, uint32_t *arr, int n); // int write_uint32_t_array(int fd, uint32_t *arr, int n);
int write_uint64_t_array(FIL fd, uint64_t *arr, int n); // int write_uint64_t_array(int fd, uint64_t *arr, int n);
int write_int8_t_array(FIL fd, int8_t *arr, int n); // int write_int8_t_array(int fd, int8_t *arr, int n);
int write_int16_t_array(FIL fd, int16_t *arr, int n); // int write_int16_t_array(int fd, int16_t *arr, int n);
int write_int32_t_array(FIL fd, int32_t *arr, int n); // int write_int32_t_array(int fd, int32_t *arr, int n);
int write_int64_t_array(FIL fd, int64_t *arr, int n); // int write_int64_t_array(int fd, int64_t *arr, int n);
int write_float_array(FIL fd, float *arr, int n); // int write_float_array(int fd, float *arr, int n);
int write_double_array(FIL fd, double *arr, int n); // int write_double_array(int fd, double *arr, int n);

int write_section_header(FIL fd); // int write_section_header(int fd);
