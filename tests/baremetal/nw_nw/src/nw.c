...
#pragma HLS INTERFACE m_axi depth=63 port=SEQA offset=slave
#pragma HLS INTERFACE m_axi depth=63 port=SEQB offset=slave
#pragma HLS INTERFACE m_axi depth=126 port=alignedA offset=slave
#pragma HLS INTERFACE m_axi depth=126 port=alignedB offset=slave
#pragma HLS INTERFACE m_axi depth=4096 port=M offset=slave
#pragma HLS INTERFACE m_axi depth=4096 port=ptr offset=slave
