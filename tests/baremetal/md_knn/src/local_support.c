...
//             args->NL );
  ...
  memcpy(position_x, args->position_x, sizeof position_x);
  memcpy(position_y, args->position_y, sizeof position_y);
  memcpy(position_z, args->position_z, sizeof position_z);
  memcpy(NL, args->NL, sizeof NL);
  ...
  memcpy(args->force_x, force_x, sizeof force_x);
  memcpy(args->force_y, force_y, sizeof force_y);
  memcpy(args->force_z, force_z, sizeof force_z);
}
